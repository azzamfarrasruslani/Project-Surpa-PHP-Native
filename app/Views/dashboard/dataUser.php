  ...
  <div class="container w-full md:w-4/5 xl:w-3/5 mx-auto px-2">
    ...
    <div class="w-full px-2 py-6 mx-auto">
      <div class="flex-none w-full max-w-full px-4">
        <div
          class="relative flex flex-col min-w-0 mb-6 pb-5 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
          <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
          <h2 class="text-xl font-bold mb-4">Data Paket Masuk</h2>
          </div>
          <!--Container-->
          <div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-5">
            <!--Card-->
            <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
              ...
              <table id="example" class="stripe hover mb-12"
                ...
                <tbody>
                  <?php foreach ($serah_terima as $item): ?>
                    <tr>
                      <td>
                        <?= $item['id_serah_terima'] ?>
                      </td>
                      <td>
                        <?= $item['posisi'] ?>
                      </td>
                      ...
                      <td>
                        <a href="edit.php?id=<?= $item['id_serah_terima'] ?>"
                          class="mx-2"><i class="fa-solid fa-pen-to-square fa-xl" style="color: #0091ff;"></i></a>
                          <a href="delete.php?id=<?= $item['id_serah_terima'] ?>" class="text-red-500 hover:text-red-700"
                          onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa-solid fa-trash fa-xl" style="color: #ff004c;"></i></a>
                        </td>
                      <td>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th data-priority="3">Status</th>
                    <th data-priority="4">Waktu Terima</th>
                    <th data-priority="5">Waktu Penyerahan</th>
                    <th data-priority="6">Nama Kurir</th>
                  </tr>
                </tfoot>
              </table>
...
<script src="../../../../Project_Surpa/public/js/plugins/perfect-scrollbar.min.js" async></script>
<!-- main script file  -->
<script src="../../../../Project_Surpa/public/js/argon-dashboard-tailwind.js?v=1.0.1" async></script>
